...
// ==============================================================
#ifndef __compute_mul_14ns_eOg__HH__
#define __compute_mul_14ns_eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(compute_mul_14ns_eOg) {
    ...
    SC_CTOR(compute_mul_14ns_eOg):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
