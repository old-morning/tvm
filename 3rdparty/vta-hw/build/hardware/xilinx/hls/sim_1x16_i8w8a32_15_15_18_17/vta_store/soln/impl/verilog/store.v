...
(* CORE_GENERATION_INFO="store,hls_ip_2020_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=7.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.125000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=4,HLS_SYN_DSP=0,HLS_SYN_FF=1481,HLS_SYN_LUT=2465,HLS_VERSION=2020_1}" *)
...
reg   [0:0] icmp_ln552_reg_640;
reg   [0:0] icmp_ln552_reg_640_pp0_iter3_reg;
...
wire   [31:0] zext_ln552_fu_348_p1;
reg   [31:0] zext_ln552_reg_607;
wire   [15:0] y_fu_357_p2;
reg   [15:0] y_reg_615;
reg    ap_predicate_op57_write_state2;
reg    ap_block_state2_io;
wire   [33:0] add_ln551_fu_375_p2;
reg   [33:0] add_ln551_reg_620;
wire   [13:0] shl_ln_fu_401_p3;
reg   [13:0] shl_ln_reg_635;
wire   [0:0] icmp_ln552_fu_409_p2;
...
reg   [0:0] icmp_ln552_reg_640_pp0_iter1_reg;
reg   [0:0] icmp_ln552_reg_640_pp0_iter2_reg;
wire   [16:0] add_ln552_fu_414_p2;
...
wire   [0:0] icmp_ln552_1_fu_461_p2;
reg   [0:0] icmp_ln552_1_reg_675;
wire   [7:0] sub_ln552_2_fu_520_p2;
reg   [7:0] sub_ln552_2_reg_682;
wire   [127:0] lshr_ln552_fu_530_p2;
reg   [127:0] lshr_ln552_reg_687;
wire   [63:0] trunc_ln552_2_fu_550_p1;
reg   [63:0] trunc_ln552_2_reg_692;
...
wire   [63:0] zext_ln552_1_fu_439_p1;
wire   [63:0] zext_ln551_fu_387_p1;
...
wire   [12:0] trunc_ln552_fu_397_p1;
wire   [13:0] trunc_ln552_1_fu_420_p1;
wire   [13:0] add_ln552_1_fu_424_p2;
wire   [12:0] lshr_ln552_1_fu_429_p4;
wire   [7:0] zext_ln552_2_fu_467_p1;
wire   [7:0] zext_ln552_3_fu_470_p1;
wire   [7:0] sub_ln552_fu_482_p2;
wire   [7:0] sub_ln552_1_fu_494_p2;
reg   [127:0] tmp_7_fu_473_p4;
wire   [7:0] xor_ln552_fu_488_p2;
wire   [7:0] select_ln552_fu_500_p3;
wire   [7:0] select_ln552_2_fu_513_p3;
wire   [127:0] select_ln552_1_fu_507_p3;
wire   [127:0] zext_ln552_4_fu_526_p1;
wire   [127:0] zext_ln552_5_fu_536_p1;
wire   [127:0] lshr_ln552_2_fu_539_p2;
wire   [127:0] and_ln552_fu_545_p2;
...
always @ (posedge ap_clk) begin
    if (((data_port_BVALID == 1'b1) & (1'b1 == ap_CS_fsm_state13))) begin
        ...
        dram_idx_V_reg_232 <= {{store_queue_V_V_TDATA_int[57:26]}};
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln552_fu_409_p2 == 1'd0))) begin
        phi_ln552_reg_253 <= add_ln552_fu_414_p2;
    end else if (((data_port_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
        phi_ln552_reg_253 <= 17'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((data_port_BVALID == 1'b1) & (1'b1 == ap_CS_fsm_state13))) begin
        ...
        sram_idx_V_0_reg_222 <= {{store_queue_V_V_TDATA_int[25:10]}};
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state2_io) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln547_fu_352_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if ((~((store_queue_V_V_TVALID_int == 1'b0) | (ap_start == 1'b0) | ((g2s_dep_queue_V_TVALID_int == 1'b0) & (tmp_2_fu_288_p3 == 1'd1))) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        zext_ln552_reg_607[16 : 1] <= zext_ln552_fu_348_p1[16 : 1];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln552_reg_640 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln552_fu_409_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln552_reg_640_pp0_iter1_reg == 1'd0))) begin
        lshr_ln552_reg_687 <= lshr_ln552_fu_530_p2;
        sub_ln552_2_reg_682[7 : 1] <= sub_ln552_2_fu_520_p2[7 : 1];
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state2_io) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln547_fu_352_p2 == 1'd1))) begin
        tmp_6_reg_625 <= tmp_V_reg_569[32'd5];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln552_reg_640_pp0_iter2_reg == 1'd0))) begin
...
always @ (*) begin
    if ((icmp_ln552_fu_409_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter4 == 1'b1) & (icmp_ln552_reg_640_pp0_iter3_reg == 1'd0))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter4 == 1'b1) & (icmp_ln552_reg_640_pp0_iter3_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state14) & (tmp_6_reg_625 == 1'd1)) | ((1'b1 == ap_CS_fsm_state2) & (tmp_6_fu_380_p3 == 1'd1) & (icmp_ln547_fu_352_p2 == 1'd1)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            ...
            end else if (((1'b0 == ap_block_state2_io) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln547_fu_352_p2 == 1'd0))) begin
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln552_fu_409_p2 == 1'd1)) & ~((ap_enable_reg_pp0_iter3 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter4 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln552_fu_409_p2 == 1'd1)) | ((ap_enable_reg_pp0_iter3 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter4 == 1'b1)))) begin
...
assign add_ln551_fu_375_p2 = (p_cast4_reg_564 + zext_ln1352_fu_371_p1);

assign add_ln552_1_fu_424_p2 = (shl_ln_reg_635 + trunc_ln552_1_fu_420_p1);

assign add_ln552_fu_414_p2 = (phi_ln552_reg_253 + 17'd1);

assign and_ln552_fu_545_p2 = (lshr_ln552_reg_687 & lshr_ln552_2_fu_539_p2);
...
always @ (*) begin
    ap_block_state8_io = ((data_port_WREADY == 1'b0) & (icmp_ln552_reg_640_pp0_iter3_reg == 1'd0));
end
...
always @ (*) begin
    ap_predicate_op57_write_state2 = ((tmp_6_fu_380_p3 == 1'd1) & (icmp_ln547_fu_352_p2 == 1'd1));
end
...
assign data_port_AWADDR = zext_ln551_fu_387_p1;

assign empty_10_fu_455_p2 = (tmp_8_fu_448_p3 | 7'd63);

assign empty_9_fu_444_p1 = phi_ln552_reg_253[0:0];

assign icmp_ln547_fu_352_p2 = ((y_0_reg_242 == tmp_reg_587) ? 1'b1 : 1'b0);

assign icmp_ln552_1_fu_461_p2 = ((tmp_8_fu_448_p3 > empty_10_fu_455_p2) ? 1'b1 : 1'b0);

assign icmp_ln552_fu_409_p2 = ((phi_ln552_reg_253 == and_ln_reg_602) ? 1'b1 : 1'b0);

assign lshr_ln552_1_fu_429_p4 = {{add_ln552_1_fu_424_p2[13:1]}};

assign lshr_ln552_2_fu_539_p2 = 128'd340282366920938463463374607431768211455 >> zext_ln552_5_fu_536_p1;

assign lshr_ln552_fu_530_p2 = select_ln552_1_fu_507_p3 >> zext_ln552_4_fu_526_p1;

assign out_mem_V_Addr_A = out_mem_V_Addr_A_orig << 32'd4;

assign out_mem_V_Addr_A_orig = zext_ln552_1_fu_439_p1;
...
assign select_ln552_1_fu_507_p3 = ((icmp_ln552_1_reg_675[0:0] === 1'b1) ? tmp_7_fu_473_p4 : out_mem_V_load_reg_659);

assign select_ln552_2_fu_513_p3 = ((icmp_ln552_1_reg_675[0:0] === 1'b1) ? xor_ln552_fu_488_p2 : zext_ln552_2_fu_467_p1);

assign select_ln552_fu_500_p3 = ((icmp_ln552_1_reg_675[0:0] === 1'b1) ? sub_ln552_fu_482_p2 : sub_ln552_1_fu_494_p2);

assign shl_ln_fu_401_p3 = {{trunc_ln552_fu_397_p1}, {1'd0}};

assign sram_idx_V_1_fu_554_p2 = (trunc_ln2_reg_592 + sram_idx_V_0_reg_222);

assign sub_ln552_1_fu_494_p2 = (zext_ln552_3_fu_470_p1 - zext_ln552_2_fu_467_p1);

assign sub_ln552_2_fu_520_p2 = (8'd127 - select_ln552_fu_500_p3);

assign sub_ln552_fu_482_p2 = (zext_ln552_2_fu_467_p1 - zext_ln552_3_fu_470_p1);
...
assign trunc_ln552_1_fu_420_p1 = phi_ln552_reg_253[13:0];

assign trunc_ln552_2_fu_550_p1 = and_ln552_fu_545_p2[63:0];

assign trunc_ln552_fu_397_p1 = sram_idx_V_0_reg_222[12:0];

assign xor_ln552_fu_488_p2 = (zext_ln552_2_fu_467_p1 ^ 8'd127);
...
assign zext_ln551_fu_387_p1 = add_ln551_reg_620;

assign zext_ln552_1_fu_439_p1 = lshr_ln552_1_fu_429_p4;

assign zext_ln552_2_fu_467_p1 = tmp_8_reg_665;

assign zext_ln552_3_fu_470_p1 = empty_10_reg_670;

assign zext_ln552_4_fu_526_p1 = select_ln552_2_fu_513_p3;

assign zext_ln552_5_fu_536_p1 = sub_ln552_2_reg_682;

assign zext_ln552_fu_348_p1 = and_ln_fu_340_p3;

always @ (posedge ap_clk) begin
    p_cast4_reg_564[33:29] <= 5'b00000;
    zext_ln304_reg_597[31:16] <= 16'b0000000000000000;
    and_ln_reg_602[0] <= 1'b0;
    zext_ln552_reg_607[0] <= 1'b0;
    zext_ln552_reg_607[31:17] <= 15'b000000000000000;
    shl_ln_reg_635[0] <= 1'b0;
    tmp_8_reg_665[5:0] <= 6'b000000;
    empty_10_reg_670[5:0] <= 6'b111111;
    sub_ln552_2_reg_682[0] <= 1'b0;
end
