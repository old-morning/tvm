...
// ==============================================================
#ifndef __compute_mul_46ns_cud__HH__
#define __compute_mul_46ns_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(compute_mul_46ns_cud) {
    ...
    SC_CTOR(compute_mul_46ns_cud):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
