...
// ==============================================================
#ifndef __compute_mac_muladfYi__HH__
#define __compute_mac_muladfYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(compute_mac_muladfYi) {
    ...
    SC_CTOR(compute_mac_muladfYi):  simcore_mac_0_U ("simcore_mac_0_U") {
