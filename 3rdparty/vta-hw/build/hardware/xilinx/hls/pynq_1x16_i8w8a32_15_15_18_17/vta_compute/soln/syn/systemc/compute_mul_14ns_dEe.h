...
// ==============================================================
#ifndef __compute_mul_14ns_dEe__HH__
#define __compute_mul_14ns_dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(compute_mul_14ns_dEe) {
    ...
    SC_CTOR(compute_mul_14ns_dEe):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
