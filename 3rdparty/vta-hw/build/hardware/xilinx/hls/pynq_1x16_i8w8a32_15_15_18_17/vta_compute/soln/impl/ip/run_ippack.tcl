...
set IPName      "compute"
set Version     "1.0"
set DisplayName "Compute"
set Revision    "2113610456"
...
set sdx_kernel_name "compute"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "/mnt/e/_AI/tvm/3rdparty/vta-hw/build/hardware/xilinx/hls/pynq_1x16_i8w8a32_15_15_18_17/vta_compute/soln"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {compute_mul_32ns_bkb
...
set Interfaces {
    s_axi_CONTROL_BUS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 done_i W 0x0 "Data signal of done_i" {{0 32 done_i W 0 "Bit 31 to 0 Data signal of done_i"}}} {0x18 done_o R 0x0 "Data signal of done_o" {{0 32 done_o R 0 "Bit 31 to 0 Data signal of done_o"}}} {0x1c done_o_ctrl R 0x0 "Control signal of done_o" {{0 1 done_o_ap_vld R 0 "Control signal done_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 uops_V W 0x0 "Data signal of uops_V" {{0 32 uops_V W 0 "Bit 31 to 0 Data signal of uops_V"}}} {0x28 biases_V W 0x0 "Data signal of biases_V" {{0 32 biases_V W 0 "Bit 31 to 0 Data signal of biases_V"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_CONTROL_BUS m_axi_uop_port m_axi_data_port gemm_queue_V_V l2g_dep_queue_V s2g_dep_queue_V g2l_dep_queue_V g2s_dep_queue_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_uop_port {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_uop_port"
        data_width "32"
        param_prefix "C_M_AXI_UOP_PORT"
