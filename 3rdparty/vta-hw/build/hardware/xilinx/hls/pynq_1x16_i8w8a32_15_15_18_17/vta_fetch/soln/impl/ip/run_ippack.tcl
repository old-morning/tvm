...
set sdx_kernel_name "fetch"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "/mnt/e/_AI/tvm/3rdparty/vta-hw/build/hardware/xilinx/hls/pynq_1x16_i8w8a32_15_15_18_17/vta_fetch/soln"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {fetch_CONTROL_BUS_s_axi
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_CONTROL_BUS m_axi_ins_port load_queue_V_V gemm_queue_V_V store_queue_V_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_ins_port {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_ins_port"
        data_width "128"
        param_prefix "C_M_AXI_INS_PORT"
