...
################################################################
# This is a generated script based on design: bd_0f32
#
...
proc create_hier_cell_s03_nodes { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net m_sc_clk_1 [get_bd_pins m_sc_clk] [get_bd_pins s03_ar_node/m_sc_aclk] [get_bd_pins s03_aw_node/m_sc_aclk] [get_bd_pins s03_b_node/s_sc_aclk] [get_bd_pins s03_r_node/s_sc_aclk] [get_bd_pins s03_w_node/m_sc_aclk]
  connect_bd_net -net m_sc_resetn_1 [get_bd_pins m_sc_resetn] [get_bd_pins s03_ar_node/m_sc_aresetn] [get_bd_pins s03_aw_node/m_sc_aresetn] [get_bd_pins s03_b_node/s_sc_aresetn] [get_bd_pins s03_r_node/s_sc_aresetn] [get_bd_pins s03_w_node/m_sc_aresetn]
  connect_bd_net -net s_sc_clk_1 [get_bd_pins s_sc_clk] [get_bd_pins s03_ar_node/s_sc_aclk] [get_bd_pins s03_aw_node/s_sc_aclk] [get_bd_pins s03_b_node/m_sc_aclk] [get_bd_pins s03_r_node/m_sc_aclk] [get_bd_pins s03_w_node/s_sc_aclk]
  connect_bd_net -net s_sc_resetn_1 [get_bd_pins s_sc_resetn] [get_bd_pins s03_ar_node/s_sc_aresetn] [get_bd_pins s03_aw_node/s_sc_aresetn] [get_bd_pins s03_b_node/m_sc_aresetn] [get_bd_pins s03_r_node/m_sc_aresetn] [get_bd_pins s03_w_node/s_sc_aresetn]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net S_SC_AW_4 [get_bd_intf_pins s03_axi2sc/M_SC_AW] [get_bd_intf_pins s03_nodes/S_SC_AW]
  connect_bd_intf_net -intf_net S_SC_AW_5 [get_bd_intf_pins s04_axi2sc/M_SC_AW] [get_bd_intf_pins s04_nodes/S_SC_AW]
  ...
  connect_bd_intf_net -intf_net S_SC_B_4 [get_bd_intf_pins s03_nodes/S_SC_B] [get_bd_intf_pins switchboards/M03_SC_B]
  connect_bd_intf_net -intf_net S_SC_B_5 [get_bd_intf_pins s04_nodes/S_SC_B] [get_bd_intf_pins switchboards/M04_SC_B]
  ...
  connect_bd_intf_net -intf_net S_SC_W_4 [get_bd_intf_pins s03_axi2sc/M_SC_W] [get_bd_intf_pins s03_nodes/S_SC_W]
  connect_bd_intf_net -intf_net S_SC_W_5 [get_bd_intf_pins s04_axi2sc/M_SC_W] [get_bd_intf_pins s04_nodes/S_SC_W]
