...
architecture behav of store is 
    ...
    "store,hls_ip_2020_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=7.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.125000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=4,HLS_SYN_DSP=0,HLS_SYN_FF=1481,HLS_SYN_LUT=2465,HLS_VERSION=2020_1}";
    ...
    signal icmp_ln552_reg_640 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln552_reg_640_pp0_iter3_reg : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln547_fu_352_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal phi_ln552_reg_253 : STD_LOGIC_VECTOR (16 downto 0);
    ...
    signal zext_ln552_fu_348_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln552_reg_607 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal add_ln551_fu_375_p2 : STD_LOGIC_VECTOR (33 downto 0);
    signal add_ln551_reg_620 : STD_LOGIC_VECTOR (33 downto 0);
    signal shl_ln_fu_401_p3 : STD_LOGIC_VECTOR (13 downto 0);
    signal shl_ln_reg_635 : STD_LOGIC_VECTOR (13 downto 0);
    signal icmp_ln552_fu_409_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln552_reg_640_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln552_reg_640_pp0_iter2_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln552_fu_414_p2 : STD_LOGIC_VECTOR (16 downto 0);
    ...
    signal icmp_ln552_1_fu_461_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln552_1_reg_675 : STD_LOGIC_VECTOR (0 downto 0);
    signal sub_ln552_2_fu_520_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal sub_ln552_2_reg_682 : STD_LOGIC_VECTOR (7 downto 0);
    signal lshr_ln552_fu_530_p2 : STD_LOGIC_VECTOR (127 downto 0);
    signal lshr_ln552_reg_687 : STD_LOGIC_VECTOR (127 downto 0);
    signal trunc_ln552_2_fu_550_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal zext_ln552_1_fu_439_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln551_fu_387_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal trunc_ln552_fu_397_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal trunc_ln552_1_fu_420_p1 : STD_LOGIC_VECTOR (13 downto 0);
    signal add_ln552_1_fu_424_p2 : STD_LOGIC_VECTOR (13 downto 0);
    signal lshr_ln552_1_fu_429_p4 : STD_LOGIC_VECTOR (12 downto 0);
    signal zext_ln552_2_fu_467_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal zext_ln552_3_fu_470_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal sub_ln552_fu_482_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal sub_ln552_1_fu_494_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_7_fu_473_p4 : STD_LOGIC_VECTOR (127 downto 0);
    signal xor_ln552_fu_488_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal select_ln552_fu_500_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal select_ln552_2_fu_513_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal select_ln552_1_fu_507_p3 : STD_LOGIC_VECTOR (127 downto 0);
    signal zext_ln552_4_fu_526_p1 : STD_LOGIC_VECTOR (127 downto 0);
    signal zext_ln552_5_fu_536_p1 : STD_LOGIC_VECTOR (127 downto 0);
    signal lshr_ln552_2_fu_539_p2 : STD_LOGIC_VECTOR (127 downto 0);
    signal and_ln552_fu_545_p2 : STD_LOGIC_VECTOR (127 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((data_port_BVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state13))) then 
                ...
                dram_idx_V_reg_232 <= store_queue_V_V_TDATA_int(57 downto 26);
            end if; 
        end if;
    end process;

    phi_ln552_reg_253_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln552_fu_409_p2 = ap_const_lv1_0))) then 
                phi_ln552_reg_253 <= add_ln552_fu_414_p2;
            elsif (((data_port_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((data_port_BVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state13))) then 
                ...
                sram_idx_V_0_reg_222 <= store_queue_V_V_TDATA_int(25 downto 10);
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_state2_io) and (ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln547_fu_352_p2 = ap_const_lv1_0))) then
                add_ln551_reg_620 <= add_ln551_fu_375_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((store_queue_V_V_TVALID_int = ap_const_logic_0) or (ap_start = ap_const_logic_0) or ((g2s_dep_queue_V_TVALID_int = ap_const_logic_0) and (tmp_2_fu_288_p3 = ap_const_lv1_1)))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                ...
                trunc_ln2_reg_592 <= store_queue_V_V_TDATA_int(95 downto 80);
                    ...
                    zext_ln552_reg_607(16 downto 1) <= zext_ln552_fu_348_p1(16 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln552_reg_640 = ap_const_lv1_0))) then
                    empty_10_reg_670(6) <= empty_10_fu_455_p2(6);
                icmp_ln552_1_reg_675 <= icmp_ln552_1_fu_461_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln552_fu_409_p2 = ap_const_lv1_0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                icmp_ln552_reg_640 <= icmp_ln552_fu_409_p2;
                icmp_ln552_reg_640_pp0_iter1_reg <= icmp_ln552_reg_640;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                icmp_ln552_reg_640_pp0_iter2_reg <= icmp_ln552_reg_640_pp0_iter1_reg;
                icmp_ln552_reg_640_pp0_iter3_reg <= icmp_ln552_reg_640_pp0_iter2_reg;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln552_reg_640_pp0_iter1_reg = ap_const_lv1_0))) then
                lshr_ln552_reg_687 <= lshr_ln552_fu_530_p2;
                    sub_ln552_2_reg_682(7 downto 1) <= sub_ln552_2_fu_520_p2(7 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_state2_io) and (ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln547_fu_352_p2 = ap_const_lv1_1))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln552_reg_640_pp0_iter2_reg = ap_const_lv1_0))) then
                trunc_ln552_2_reg_692 <= trunc_ln552_2_fu_550_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                ...
                elsif (((ap_const_boolean_0 = ap_block_state2_io) and (ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln547_fu_352_p2 = ap_const_lv1_0))) then
            ...
            when ap_ST_fsm_pp0_stage0 => 
                if ((not(((ap_enable_reg_pp0_iter1 = ap_const_logic_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln552_fu_409_p2 = ap_const_lv1_1))) and not(((ap_enable_reg_pp0_iter3 = ap_const_logic_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter4 = ap_const_logic_1))))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                elsif ((((ap_enable_reg_pp0_iter1 = ap_const_logic_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln552_fu_409_p2 = ap_const_lv1_1)) or ((ap_enable_reg_pp0_iter3 = ap_const_logic_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter4 = ap_const_logic_1)))) then
    ...
    add_ln551_fu_375_p2 <= std_logic_vector(unsigned(p_cast4_reg_564) + unsigned(zext_ln1352_fu_371_p1));
    add_ln552_1_fu_424_p2 <= std_logic_vector(unsigned(shl_ln_reg_635) + unsigned(trunc_ln552_1_fu_420_p1));
    add_ln552_fu_414_p2 <= std_logic_vector(unsigned(phi_ln552_reg_253) + unsigned(ap_const_lv17_1));
    and_ln552_fu_545_p2 <= (lshr_ln552_reg_687 and lshr_ln552_2_fu_539_p2);
    ...
    ap_block_state8_io_assign_proc : process(icmp_ln552_reg_640_pp0_iter3_reg, data_port_WREADY)
    begin
                ap_block_state8_io <= ((data_port_WREADY = ap_const_logic_0) and (icmp_ln552_reg_640_pp0_iter3_reg = ap_const_lv1_0));
    end process;

        ap_block_state8_pp0_stage0_iter4 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_condition_pp0_exit_iter0_state4_assign_proc : process(icmp_ln552_fu_409_p2)
    begin
        if ((icmp_ln552_fu_409_p2 = ap_const_lv1_1)) then 
    ...
    ap_predicate_op57_write_state2_assign_proc : process(icmp_ln547_fu_352_p2, tmp_6_fu_380_p3)
    begin
                ap_predicate_op57_write_state2 <= ((tmp_6_fu_380_p3 = ap_const_lv1_1) and (icmp_ln547_fu_352_p2 = ap_const_lv1_1));
    end process;
    ...
    data_port_AWADDR <= zext_ln551_fu_387_p1(32 - 1 downto 0);
    ...
    data_port_WVALID_assign_proc : process(ap_enable_reg_pp0_iter4, icmp_ln552_reg_640_pp0_iter3_reg, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter4 = ap_const_logic_1) and (icmp_ln552_reg_640_pp0_iter3_reg = ap_const_lv1_0))) then 
    ...
    data_port_blk_n_W_assign_proc : process(m_axi_data_port_WREADY, ap_enable_reg_pp0_iter4, ap_block_pp0_stage0, icmp_ln552_reg_640_pp0_iter3_reg)
    begin
        if (((ap_enable_reg_pp0_iter4 = ap_const_logic_1) and (icmp_ln552_reg_640_pp0_iter3_reg = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    empty_9_fu_444_p1 <= phi_ln552_reg_253(1 - 1 downto 0);
    ...
    icmp_ln547_fu_352_p2 <= "1" when (y_0_reg_242 = tmp_reg_587) else "0";
    icmp_ln552_1_fu_461_p2 <= "1" when (unsigned(tmp_8_fu_448_p3) > unsigned(empty_10_fu_455_p2)) else "0";
    icmp_ln552_fu_409_p2 <= "1" when (phi_ln552_reg_253 = and_ln_reg_602) else "0";
    lshr_ln552_1_fu_429_p4 <= add_ln552_1_fu_424_p2(13 downto 1);
    lshr_ln552_2_fu_539_p2 <= std_logic_vector(shift_right(unsigned(ap_const_lv128_lc_3),to_integer(unsigned('0' & zext_ln552_5_fu_536_p1(31-1 downto 0)))));
    lshr_ln552_fu_530_p2 <= std_logic_vector(shift_right(unsigned(select_ln552_1_fu_507_p3),to_integer(unsigned('0' & zext_ln552_4_fu_526_p1(31-1 downto 0)))));
    ...
    out_mem_V_Addr_A_orig <= zext_ln552_1_fu_439_p1(32 - 1 downto 0);
    ...
    s2g_dep_queue_V_TDATA_blk_n_assign_proc : process(ap_CS_fsm_state2, icmp_ln547_fu_352_p2, tmp_6_fu_380_p3, ap_CS_fsm_state14, tmp_6_reg_625, s2g_dep_queue_V_TREADY_int)
    begin
        if ((((ap_const_logic_1 = ap_CS_fsm_state14) and (tmp_6_reg_625 = ap_const_lv1_1)) or ((ap_const_logic_1 = ap_CS_fsm_state2) and (tmp_6_fu_380_p3 = ap_const_lv1_1) and (icmp_ln547_fu_352_p2 = ap_const_lv1_1)))) then 
    ...
    select_ln552_1_fu_507_p3 <= 
        tmp_7_fu_473_p4 when (icmp_ln552_1_reg_675(0) = '1') else 
        out_mem_V_load_reg_659;
    select_ln552_2_fu_513_p3 <= 
        xor_ln552_fu_488_p2 when (icmp_ln552_1_reg_675(0) = '1') else 
        zext_ln552_2_fu_467_p1;
    select_ln552_fu_500_p3 <= 
        sub_ln552_fu_482_p2 when (icmp_ln552_1_reg_675(0) = '1') else 
        sub_ln552_1_fu_494_p2;
    shl_ln_fu_401_p3 <= (trunc_ln552_fu_397_p1 & ap_const_lv1_0);
    ...
    sub_ln552_1_fu_494_p2 <= std_logic_vector(unsigned(zext_ln552_3_fu_470_p1) - unsigned(zext_ln552_2_fu_467_p1));
    sub_ln552_2_fu_520_p2 <= std_logic_vector(unsigned(ap_const_lv8_7F) - unsigned(select_ln552_fu_500_p3));
    sub_ln552_fu_482_p2 <= std_logic_vector(unsigned(zext_ln552_2_fu_467_p1) - unsigned(zext_ln552_3_fu_470_p1));
    ...
    trunc_ln552_1_fu_420_p1 <= phi_ln552_reg_253(14 - 1 downto 0);
    trunc_ln552_2_fu_550_p1 <= and_ln552_fu_545_p2(64 - 1 downto 0);
    trunc_ln552_fu_397_p1 <= sram_idx_V_0_reg_222(13 - 1 downto 0);
    xor_ln552_fu_488_p2 <= (zext_ln552_2_fu_467_p1 xor ap_const_lv8_7F);
    ...
    zext_ln551_fu_387_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln551_reg_620),64));
    zext_ln552_1_fu_439_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(lshr_ln552_1_fu_429_p4),64));
    zext_ln552_2_fu_467_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_8_reg_665),8));
    zext_ln552_3_fu_470_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(empty_10_reg_670),8));
    zext_ln552_4_fu_526_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln552_2_fu_513_p3),128));
    zext_ln552_5_fu_536_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sub_ln552_2_reg_682),128));
    zext_ln552_fu_348_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(and_ln_fu_340_p3),32));
end behav;
