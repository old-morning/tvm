...
(* CORE_GENERATION_INFO="load,hls_ip_2020_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=7.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=9.275000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=4,HLS_SYN_DSP=0,HLS_SYN_FF=4241,HLS_SYN_LUT=18147,HLS_VERSION=2020_1}" *)
...
reg   [63:0] data_port_addr_1_rea_reg_1301;
...
always @ (posedge ap_clk) begin
    if ((grp_reset_mem_fu_418_ap_done == 1'b1)) begin
        if ((1'b1 == ap_CS_fsm_state31)) begin
            ...
            dram_idx_assign_0_reg_386 <= {{tmp_V_reg_1172[57:26]}};
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state15)) begin
        ...
        dram_idx_assign_1_0_reg_344 <= {{tmp_V_reg_1172[57:26]}};
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state15)) begin
        ...
        sram_idx_V_assign_1_s_reg_334 <= {{tmp_V_reg_1172[25:10]}};
    end
end
...
assign add_ln700_2_fu_888_p2 = (trunc_ln200_1_reg_1196 + sram_idx_V_assign_1_s_reg_334);
...
always @ (*) begin
    ap_block_state32_on_subcall_done = ((grp_reset_mem_fu_418_ap_done == 1'b0) & (icmp_ln206_reg_1230 == 1'd1));
end
...
assign trunc_ln2_fu_609_p4 = {{tmp_V_reg_1172[9:7]}};

assign trunc_ln67_1_fu_977_p1 = phi_ln67_reg_407[13:0];

assign trunc_ln67_2_fu_996_p1 = phi_ln67_reg_407[0:0];

assign trunc_ln67_fu_955_p1 = grp_reset_mem_fu_418_ap_return[12:0];
...
assign zext_ln89_4_fu_770_p1 = data_port_addr_1_rea_reg_1301;
